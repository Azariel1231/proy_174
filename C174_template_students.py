...
#----------------------------Imagen de la carga------------ 
#Carga la imagen del logotipo y almacénala en la variable image.
image = ImageTk.PhotoImage((Image.open("image7.png")))


place_image=Label(root)
#Actualiza la propiedad "image" de la variable place_image
...
label = Label(root, text="Asignar trabajos", )
...
label_IT.place(relx=0.06, rely=0.45, ancho=CENTER)
...
label_chemical.place(relx=0.07, rely=0.75, ancho=CENTER)
